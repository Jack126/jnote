...
public class JnoteUser implements UserDetails {
    ...
    public List<JnoteRole> getRoles() {
        return roles;
    }

    public void setRoles(List<JnoteRole> roles) {
        this.roles = roles;
    }
